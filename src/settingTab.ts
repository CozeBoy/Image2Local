		...
		new Setting(containerEl)
			...
			.addDropdown((dropdown) => {
				const modes: { value: StorageMode; label: string }[] = [
					{ value: 'relative-to-note', label: tr('storageModeNote') },
					{ value: 'relative-to-vault', label: tr('storageModeVault') },
					{ value: 'absolute', label: tr('storageModeAbsolute') },
					{ value: 'system-absolute', label: tr('storageModeSystemAbsolute') },
				];
